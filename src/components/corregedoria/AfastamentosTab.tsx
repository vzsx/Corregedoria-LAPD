                          ...
                          return (
                            <>
                              ...
                              <div className="flex gap-2 items-end">
                                ...
                                <Button size="sm" onClick={() => handleLinkAfastamentoDenuncia(a.id)} disabled={linking || !linkAfastamentoDenunciaId} className="bg-pmesp-sidebar hover:bg-pmesp-red text-[#ECECEC] text-xs h-9">
                          ...
                          return (
                            <>
                              ...
                              <div className="flex gap-2 items-end">
                                ...
                                <Button size="sm" onClick={() => handleLinkAfastamentoInvestigacao(a.id)} disabled={linking || !linkAfastamentoInvestigacaoId} className="bg-pmesp-sidebar hover:bg-pmesp-red text-[#ECECEC] text-xs h-9">
                                  {linking ? "Vinculando..." : "Vincular"}
                                </Button>
                              </div>
                            </>
                          ...
                          return (
                            <>
                              ...
                              <div className="flex gap-2 items-end">
                                ...
                                <Button size="sm" onClick={() => handleLinkAfastamentoRelatorio(a.id)} disabled={linking || !linkAfastamentoRelatorioId} className="bg-pmesp-sidebar hover:bg-pmesp-red text-[#ECECEC] text-xs h-9">
                                  {linking ? "Vinculando..." : "Vincular"}
                                </Button>
                              </div>
                            </>
                          ...
                          return (
                            <>
                              ...
                              <div className="flex gap-2 items-end">
                                ...
                                <Button size="sm" onClick={() => handleLinkAfastamentoDepoimento(a.id)} disabled={linking || !linkAfastamentoDepoimentoId} className="bg-pmesp-sidebar hover:bg-pmesp-red text-[#ECECEC] text-xs h-9">
                                  {linking ? "Vinculando..." : "Vincular"}
                                </Button>
                              </div>
                            </>
