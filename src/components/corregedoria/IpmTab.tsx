                          ...
                          <>
                            ...
                            <div className="flex gap-2 items-end">
                              ...
                              <Button size="sm" onClick={() => handleLinkIpm(ipm.id, denunciaLinkId, "denuncia")}
                                disabled={parentLinking || !denunciaLinkId} className="bg-pmesp-sidebar hover:bg-pmesp-red text-[#D0D0D0] text-xs">
                          ...
                          <>
                            ...
                            <div className="flex gap-2 items-end">
                              ...
                              <Button size="sm" onClick={() => handleLinkIpm(ipm.id, investigacaoLinkId, "investigacao")}
                                disabled={parentLinking || !investigacaoLinkId} className="bg-pmesp-sidebar hover:bg-pmesp-red text-[#D0D0D0] text-xs">
                                {parentLinking ? "Vinculando..." : "Vincular"}
                              </Button>
                            </div>
                          </>
                          ...
                          <>
                            ...
                            <div className="flex gap-2 items-end">
                              ...
                              <Button size="sm" onClick={() => handleLinkIpm(ipm.id, atoLinkId, "relatorio")}
                                disabled={parentLinking || !atoLinkId} className="bg-pmesp-sidebar hover:bg-pmesp-red text-[#D0D0D0] text-xs">
                                {parentLinking ? "Vinculando..." : "Vincular"}
                              </Button>
                            </div>
                          </>
                          ...
                          <>
                            ...
                            <div className="flex gap-2 items-end">
                              ...
                              <Button size="sm" onClick={() => handleLinkIpm(ipm.id, depoimentoLinkId, "depoimento")}
                                disabled={parentLinking || !depoimentoLinkId} className="bg-pmesp-sidebar hover:bg-pmesp-red text-[#D0D0D0] text-xs">
                                {parentLinking ? "Vinculando..." : "Vincular"}
                              </Button>
                            </div>
                          </>
