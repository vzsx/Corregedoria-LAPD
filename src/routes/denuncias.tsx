...
function Denuncias() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const dadosDetalhados = {
      ...formData,
      reclamante_nome: finalReclamanteNome
    };
        ...
        {submitted ? (
          <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/5 p-12 text-center shadow-2xl animate-scale-in">
            ...
            <div className="mt-10 flex flex-col items-center gap-4">
              <Button asChild className="bg-emerald-600 hover:bg-emerald-500 text-[#D8D8D8] font-bold tracking-widest uppercase px-8 shadow-sm transition-all duration-300 hover:scale-105">
